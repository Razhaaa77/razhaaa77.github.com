...
<body>
		...
		<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li>
						<btn href="<?= base_url('auth') ?>">login</btn>
					</li>
				</ul>
			</nav><!-- .navbar -->
					...
					<div class="col-xl-4 col-md-6">
						<div class="post-item position-relative h-100">
							<div class="post-img position-relative overflow-hidden">
								<img src="<?= base_url('assets/flat_able/upload/konten/'. $rr['foto'])?>" class="img-fluid"  height="10px" >
								<span class="post-date"><?= $rr['tanggal'];?></span>
							</div>
							<div class="post-content d-flex flex-column">
								<h3 class="post-title"><?= $rr['judul'];?></h3>
								<div class="meta d-flex align-items-center">
									<div class="d-flex align-items-center">
										<i class="bi bi-person"></i> <span class="ps-2"><?= $rr['nama'];?></span>
									</div>
									<span class="px-3 text-black-50">/</span>
									<div class="d-flex align-items-center">
										<i class="bi bi-folder2"></i> <span class="ps-2"><?= $rr['nama_kategori'];?></span>
									</div>
								</div>
								<hr>
								<a href="<?= base_url('detail/artikel/'. $rr['slug'])?>" class="readmore stretched-link"><span>Read More</span><i
              ...
              <?= $konfig->profil_website; ?><br><br>
                ...
                <strong>Email:</strong><?= $konfig->alamat; ?><br>
							...
							<div class="social-links d-flex mt-3">
								<a href="<?= $konfig->x; ?>" class="d-flex align-items-center justify-content-center"><i class="bi bi-twitter"></i></a>
								<a href="<?= $konfig->facebook; ?>" class="d-flex align-items-center justify-content-center"><i class="bi bi-facebook"></i></a>
								<a href="<?= $konfig->instagram; ?>" class="d-flex align-items-center justify-content-center"><i class="bi bi-instagram"></i></a>
							</div>
						</div>
	...
	<!-- Vendor JS Files -->
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/aos/aos.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/glightbox/js/glightbox.min.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/swiper/swiper-bundle.min.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/purecounter/purecounter_vanilla.js"></script>
	<script src="<?= base_url('assets/flat_able/front/'); ?>assets/vendor/php-email-form/validate.js"></script>
